...
def user_search(driver, query):
    driver.get('http://www.instagram.com/')
    driver.find_element_by_css_selector('input._9x5sw._qy55y').send_keys(query)
...
class InstagramPost():
    ...
    def get_comments(self, max_comments=float('inf')):
        ...
        while (driver.find_element_by_class_name('ul._mo9iw._123ym').find_elements_by_tag_name('li')[-1] != top) and (len(driver.find_element_by_class_name('ul._mo9iw._123ym').find_elements_by_tag_name('li')) < max_comments):
            ...
            driver.execute_script('arguments[0].scrollTo(0, arguments[0].scrollHeight);', driver.find_element_by_class_name('ul._mo9iw._123ym'))
            time.sleep(2)
